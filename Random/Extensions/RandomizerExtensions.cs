...
namespace Depra.Random.Extensions
{
    public static partial class RandomizerExtensions
    {
        ...
        /// </remarks>
        public static string NextString(this IRandomizer randomizer, int length, string allowedCharacters)
        {
            if (length < 0)
            {
        ...
        public static char[] NextChars(this IRandomizer randomizer, int length,
